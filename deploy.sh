...
kubectl set image deployments/client-deployment client=epopevad/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=epopevad/multi-worker:$SHA